...
import com.versatile.repository.CustomerRepository;
import com.versatile.service.dto.CustomerDTO;
import com.versatile.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    private static final CustomerType UPDATED_CUSTOMER_TYPE = CustomerType.CLIENT;
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.fullName(UPDATED_FULL_NAME).companyName(UPDATED_COMPANY_NAME).customerType(UPDATED_CUSTOMER_TYPE);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.fullName(UPDATED_FULL_NAME).companyName(UPDATED_COMPANY_NAME).customerType(UPDATED_CUSTOMER_TYPE);
