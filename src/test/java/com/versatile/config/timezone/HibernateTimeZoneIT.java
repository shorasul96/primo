package com.versatile.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.versatile.IntegrationTest;
import com.versatile.repository.timezone.DateTimeWrapper;
import com.versatile.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM primo_date_time_wrapper where id=%d", fieldName, id);
    }
