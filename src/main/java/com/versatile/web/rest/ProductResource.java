...
import com.versatile.repository.ProductRepository;
import com.versatile.service.ProductService;
...
/**
 * REST controller for managing {@link com.versatile.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    public ResponseEntity<List<ProductDTO>> getAllProducts(
        ...
        if ("inventory-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(productService.findAllWhereInventoryIsNull(), HttpStatus.OK);
        }
